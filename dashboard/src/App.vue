...
@Component<Dashboard>({
  metaInfo() {
    return {
      ...
      { property: 'og:title', content: '💛 🖼 LUV NFT | The NFT marketplace to buy and sell what you LUV' },
      { property: 'og:type', content: 'website'},
      { property: 'og:url', content: 'https://luvnft.com'},
      { property: 'og:description', content: '💛 🖼 LUV NFT | The NFT marketplace to buy and sell what you LUV' },
      { property: 'og:site_name', content: '💛 🖼 LUV NFT | The NFT marketplace to buy and sell what you LUV'},
      // { property: 'og:image', content: '/img/icons/android-chrome-256x256.png'}
      { property: 'og:locale', content: 'en_US'},
      { property: 'twitter:card', content: 'summary_large_image' },
      { property: 'twitter:site', content: '@Luvnft' },
      { property: 'twitter:title', content: '💛 🖼 LUV NFT | The NFT marketplace to buy and sell what you LUV' },
      { property: 'twitter:description', content: ' 💛 🖼 LUV NFT | The NFT marketplace to buy and sell what you LUV' },
